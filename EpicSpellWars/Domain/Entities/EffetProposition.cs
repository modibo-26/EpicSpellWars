...
// Groupe C : on propose un choix oui/non à une cible, puis on exécute la branche correspondante.
...
//   Roulepélax : « donner UNE carte Arcane ? » oui → PasserCartes(filtre Arcane) ; non → VolerTresor sur la cible.
